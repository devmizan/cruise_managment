...
class Form{
   public static function open($config){
    global $base_url;
      ...
      $html="<form class='form app-form' action='$base_url/{$config["route"]}' method='post' enctype='multipart/form-data'>";
   ...
   public static function select($config){
     ...
     $html.="<label class='col-sm-2 col-form-label form-label' >{$config["label"]}</label>";
     ...
     return $html;
       ...
       public static function input($config){    
        ...
        if($config["type"]=="hidden" || $config["type"]=="submit" || $config["type"]=="reset"){          
          ...
          $html.="<label for='{$config["name"]}' class='col-sm-2 col-form-label form-label'>{$config["label"]}</label>";
        }
